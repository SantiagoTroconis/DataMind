    ...
    return (
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <main className="flex-grow pt-20">
                {/* Hero Section */}
                <section className="py-24 sm:py-32 border-b border-slate-100">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center max-w-3xl mx-auto">
                            <h1 className="text-4xl sm:text-6xl font-bold text-slate-900 mb-8 tracking-tight animate-in fade-in slide-in-from-bottom-5 duration-700">
                                Democratizing data for <span className="text-slate-500">everyone.</span>
                            </h1>
                            <p className="text-xl text-slate-600 leading-relaxed font-light animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
                                ...
                                <div className="aspect-square bg-slate-100 rounded-3xl overflow-hidden relative">
                                    <div className="absolute inset-0 bg-gradient-to-tr from-slate-200 to-slate-50 flex items-center justify-center">
                                        ...
                                        <div className="grid grid-cols-2 gap-4 opacity-50">
                                            ...
                                            <div className="w-16 h-16 bg-slate-900 rounded-2xl shadow-sm"></div>
                                            <div className="w-16 h-16 bg-slate-300 rounded-2xl shadow-sm"></div>
                                            <div className="w-16 h-16 bg-white rounded-2xl shadow-sm"></div>
                                        </div>
                                    </div>
                                </div>
                                {/* Floating Card */}
                                <div className="absolute -bottom-10 -right-10 bg-white p-6 rounded-2xl border border-slate-100 shadow-xl shadow-slate-200/50 max-w-xs hidden md:block">
                                    ...
                                    <p className="text-sm text-slate-500">Built with functionality requested by over 10,000 real users.</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-8 order-1 lg:order-2">
                                ...
                                <div className="pt-4">
                                    <button className="text-slate-900 font-semibold flex items-center gap-2 hover:gap-3 transition-all">
                        ...
                        {/* Values Grid */}
                        <div>
                            <h2 className="text-2xl font-bold text-slate-900 mb-12 text-center">Core Values</h2>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:border-slate-200 transition-colors">
                                    <div className="w-12 h-12 rounded-xl bg-white text-blue-600 flex items-center justify-center mb-6 shadow-sm border border-slate-100">
                                        <Heart className="w-5 h-5" />
                                    </div>
                                    <h3 className="text-lg font-bold text-slate-900 mb-3">Simplicity</h3>
                                ...
                                <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:border-slate-200 transition-colors">
                                    ...
                                    <h3 className="text-lg font-bold text-slate-900 mb-3">Innovation</h3>
                                    <p className="text-slate-500 leading-relaxed font-light">
                                ...
                                <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:border-slate-200 transition-colors">
                                    ...
                                    <h3 className="text-lg font-bold text-slate-900 mb-3">Community</h3>
                                    <p className="text-slate-500 leading-relaxed font-light">
